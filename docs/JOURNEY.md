...
최종 구성은 단순하다: **이미지 좌표 + 하단 중앙점 + Savitzky-Golay 스무딩 +
직선 차선 모델 + 6특징 규칙 점수** (확대 평가셋 F1 0.81 / PR-AUC 0.95).
복잡한 기하 보정은 전부 기각됐고, 살아남은 것은 좋은 입력(⑦), 좋은 특징(④⑩),
지점별 기준(①②), 그리고 믿을 수 있는 평가(③⑨)였다.
...
남은 것: 저진폭 차로횡단은 정상 차선변경과 형태가 같아 원리적으로 어렵고
(46%에서 정체), 지그재그는 40%. 합성이 아닌 **실제 이상 사례 라벨링**으로
이 수치의 실체를 확인하는 것, 그리고 39개 전 지점으로의 확장이 다음 장이다.
